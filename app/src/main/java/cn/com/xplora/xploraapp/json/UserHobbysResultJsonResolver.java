 ...
 */
public class UserHobbysResultJsonResolver extends BaseJsonResolver {

    public static UserHobbysResult parse(String response){
        UserHobbysResult result = new UserHobbysResult();
        try {
