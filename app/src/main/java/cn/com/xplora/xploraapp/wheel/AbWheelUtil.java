...
import cn.com.xplora.xploraapp.utils.AbStrUtil;
...
public class AbWheelUtil {
	 ...
	 */
	public static void initWheelTimePicker(final Activity activity,final TextView mText,final AbWheelView mWheelViewMD,final AbWheelView mWheelViewHH,final AbWheelView mWheelViewMM,
			 Button okBtn,Button cancelBtn,
	 ...
	 * @param initStart the init start
	 */
	public static void initWheelTimePicker2(final Activity activity,final AbWheelView mWheelViewHH,final AbWheelView mWheelViewMM,
			 Button okBtn,Button cancelBtn,
