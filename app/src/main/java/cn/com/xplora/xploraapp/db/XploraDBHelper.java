...
public class XploraDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String sql = "create table user(uuid integer primary key autoincrement,uuidInBack integer,userName text,mobile text,hobbyIds text,hobby text, hobbyEn text," +
